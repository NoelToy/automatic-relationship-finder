...
public class AutomaticRelationshipFinderTest {
    ...
    public void automaticRelationshipFinderTest(){
        ...
        List<List<String>> dataTableA = List.of(
                ...
                List.of("3","Paul", "Campbell","20","0"),
                List.of("4","Pablo", "Picasso","28","1"),
                List.of("5","Theodore", "Camp","34","1"),
                List.of("6","Henri", "Matisse","28","0"),
                List.of("7","Georges", "Braque","54","1"),
                List.of("8","Ernest", "Hemingway","55","0"),
                List.of("9","Alice", "Toklas","45","1"),
                List.of("10","Eleanor", "Roosevelt","28","0"),
                List.of("11","Edgar", "Degas","47","1"),
                List.of("12","Pierre-Auguste", "Wren","59","0"),
                List.of("13","Claude", "Monet","28","1"),
                List.of("14","Édouard", "Sorenson","25","1"),
                List.of("15","Mary", "Dunning","88","0"),
                List.of("16","Alfred", "Jones","77","0"),
                List.of("17","Joseph", "Smith","41","1"),
                List.of("18","Camille", "Pissarro","47","0"),
                List.of("19","Franklin", "Roosevelt","57","1"),
                List.of("20","Winston", "Churchill","78","0")
        );
